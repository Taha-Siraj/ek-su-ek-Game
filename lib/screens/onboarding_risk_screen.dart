...
class OnboardingRiskScreen extends StatelessWidget {
  final VoidCallback? onNext;
  final VoidCallback? onSkip;

  const OnboardingRiskScreen({
    Key? key,
    this.onNext,
    this.onSkip,
  }) : super(key: key);
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              Text(
                                "Every number counts. If your total exceeds 101, it's instant game over. Precision is key.",
                                textAlign: TextAlign.center,
        ...
        children: [
          Row(
            ...
            children: [
              ...
              _buildNumberCell("10", MidnightNeonTheme.danger),
            ],
          ),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: MidnightNeonTheme.danger.withOpacity(0.15),
